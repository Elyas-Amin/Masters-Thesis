...
public class EntityExperiments {
    ...
    public static void main(String[] args) throws Exception {
        String jsonlFilePath = "/Users/Ghamay/Documents/mastersThesis/Data/GCDC/Data/JSONLFiles/Yahoo_test.jsonl";
        boolean gridAndGraph = false;
        int projection = 0;
...
//        String jsonlFilePath = "/Users/Ghamay/Documents/mastersThesis/Data/GCDC/Data/JSONLFiles/Yahoo_train.jsonl";
...
//    }
    ...
    private void getGrid(String path, String textId, List<CoreMap> sentences) {
        // Reuse the same pipeline by passing it to the EntityGridFramework
        ...
        File outputDirectory = new File(parentDir, "../OutputData/yahoo/yahoo_test_grids");
...
//        File outputDirectory = new File(parentDir, "../OutputData/yahoo/yahoo_train_grids");
//
//        // Check if directory exists, if not, create it
//        if (!outputDirectory.exists()) {
//            boolean dirCreated = outputDirectory.mkdirs();
